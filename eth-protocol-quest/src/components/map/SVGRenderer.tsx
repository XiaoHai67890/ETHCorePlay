...
export function SVGRenderer() {
  ...
  const [lod, setLod] = useState<LOD>('plot');
    ...
    <div className="card card-hover">
      <div className="card-title-row">
        ...
        <div className="quick-links">
          <button className="btn btn-ghost" onClick={() => setLod('zone')}>Zone-only</button>
          <button className="btn btn-ghost" onClick={() => setLod('plot')}>Plot-dots</button>
          <button className="btn btn-ghost" onClick={() => setLod('edge')}>Edge lines</button>
        </div>
      </div>
